...
property :template_owner, default: node['root_user']
property :template_group, default: node['root_group']
property :base_dir, String, default: lazy { node['logrotate']['directory'] }
